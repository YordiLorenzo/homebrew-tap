class Hbkit < Formula
  ...
  url "https://files.pythonhosted.org/packages/6e/b7/d1a77c766c85c1a7abe69d77d3ba4ef21e1bf457f5a95562e68bab561b31/hbkit-0.4.2.tar.gz"
  sha256 "250e86bab2290c30fcd162544203e40bbff269837853068a4ce0aca577b2d741"
  license "MIT"
  ...
  test do
    assert_match version.to_s, shell_output("#{bin}/hbk --version")

    # `doctor` on a directory that is not an archive must fail cleanly rather
    # than traceback, which exercises argument parsing and the format probe.
